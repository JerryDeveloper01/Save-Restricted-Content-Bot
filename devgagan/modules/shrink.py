...
async def token_handler(client, message):
    ...
    if len(message.command) <= 1:
        image_url = "https://i.ibb.co/zTPJFct8/photo-2025-04-25-12-55-01-7497233558289776672.jpg"
        join_button = InlineKeyboardButton("Join Channel", url="https://t.me/nsksjjdd")
        premium = InlineKeyboardButton("Get Premium", url="https://t.me/GoldenEagleContactbot")   
